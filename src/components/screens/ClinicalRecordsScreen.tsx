        ...
        {mockClinicalRecords.map((record) => (
          ...
          >
            <View style={styles.recordHeader}>
              ...
              <View style={[styles.statusBadge, { backgroundColor: record.status === 'completed' ? '#34C759' : '#FF9500' }]}>
            ...
            <Text style={styles.date}>{new Date(record.date).toLocaleDateString('en-IN', {
              day: 'numeric',
              month: 'long',
              year: 'numeric'
            })}</Text>
